...
class Tour extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(CtptTour::className(), ['MSTOUR' => 'MSTOUR']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getMSPTs()
    {
        return $this->hasMany(Phuongtien::className(), ['MSPT' => 'MSPT'])->viaTable('{{%ctpt_tour}}', ['MSTOUR' => 'MSTOUR']);
    }
